...
To access your notebook, run
```bash
(drlcc)$ jupyter notebook
```
...
Then, place the file in the `DRL_Collab_Compete` folder and unzip (or decompress) the file.  Next, open `Soccer.ipynb` and follow the instructions to learn how to use the Python API to control the agent.
